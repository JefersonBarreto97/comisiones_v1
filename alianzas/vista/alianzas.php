                ...
                fields: {
                    ...
                    campania: {
                        ...
                        display: function(campaniaData) {
                            var $img1 = $('<img src="../../imagenes/campañas.png" title="campañas" width="25" height="25" style="cursor:pointer"/>');
                            $img1.click(function() {
                                $('#alianzas').jtable('openChildTable',
                                    $img1.closest('tr'), {
                                        title: 'Campañas de la alianza ' + campaniaData.record.nombre_alianza,
                                        actions: {
                                            listAction: '../vista/listar_campania.php?id_alianza=' + campaniaData.record.id_alianza,
                                            deleteAction: '../controlador/c_eliminar_campania.php',
                                            updateAction: '../controlador/c_actualizar_campania.php',
                                            createAction: '../controlador/c_crear_campania.php',
                                        },
                                        fields: {
                                            id_alianza: {
                                                type: 'hidden',
                                            ...
                                            asesor: {
                                                ...
                                                display: function(asesordata) {
                                                    var $img = $('<img src="../../imagenes/asesores.png" title="Agentes" width="25" height="25" style="cursor:pointer"/>');
                                                    $img.click(function() {
                                                        $('#alianzas').jtable('openChildTable',
                                                            $img.closest('tr'), {
                                                                title: 'Asesores De La Campaña ' + asesordata.record.nombre_campania,
                                                                actions: {
                                                                    listAction: '../vista/listar_asesor.php?id_campania=' + asesordata.record.id_campania,
                                                                    deleteAction: '../controlador/c_eliminar_asesor.php',
                                                                    updateAction: '../controlador/c_actualizar_asesor.php',
                                                                    createAction: '../controlador/c_crear_asesor.php'
                                                                },
                                                                fields: {
                                                                    id_campania: {
                                                                        type: 'hidden',
                                            ...
                                            meta: {
                                                ...
                                                display: function(metasdata) {
                                                    var $img = $('<img src="../../imagenes/metas.png" title="Metas" width="25" height="25" style="cursor:pointer"/>');
                                                    $img.click(function() {
                                                        $('#alianzas').jtable('openChildTable',
                                                            $img.closest('tr'), {
                                                                title: 'Metas De La Campaña  ' + metasdata.record.nombre_campania,
                                                                actions: {
                                                                    listAction: '../vista/listar_meta.php?id_campania=' + metasdata.record.id_campania,
                                                                    deleteAction: '../controlador/c_eliminar_meta.php',
                                                                    updateAction: '../controlador/c_actualizar_meta.php',
                                                                    createAction: '../controlador/c_crear_meta.php'
                                                                },
                                                                fields: {
                                                                    id_campania: {
                                                                        type: 'hidden',
